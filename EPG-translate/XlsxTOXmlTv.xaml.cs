...
{
    /// <summary>
    /// Lógica de interacción para XlsxTOXmlTv.xaml
    /// </summary>
    public partial class XlsxTOXmlTv : Window
    {
        ...
        public XlsxTOXmlTv(string id, string canal, string rutaExcel, string hojaExcel, string hoja2Excel)
        {
            InitializeComponent();
            ...
            Ingestar.Visibility = Visibility.Hidden;
        ...
        private void inicioConversion(object sender, EventArgs e)
        {
            ...
            else if (count == 4)
            {
                ...
                if (corroborador==0)
                {
                    ...
                    resultado.Content = "Conversión completa";
                    Ingestar.Visibility = Visibility.Visible;
                ...
                else
                {
                    ...
                    resultado.Content = "Hubo errores en la conversion del archivo\nImposible continuar con el proceso";
        ...
        private void Ingestar_Click(object sender, RoutedEventArgs e)
        {
            //como todo salio bien procedemos a pasar a la ventana donde se realizaran los pasos para ingestar el archivo
            IngestaD ingestaD = new IngestaD(Int32.Parse(Id));
            ingestaD.Show();
            this.Hide();
        }
            ...
            try
            {
                ...
                if (openfiledialog.ShowDialog() == true)
                {
                   Process proceso = new Process();
                    proceso.StartInfo.FileName = openfiledialog.FileName;
                    proceso.Start();
                }
